...
export class MainpageComponent implements OnInit {
  ...
  //       {
  //         img:
  //           "http://www.topherci.cz/wp-content/gallery/adam-sandler/adam-sandler-1.jpg",
  //         name: "Adam Sandler",
  //         phone: "98761435"
  //       },
  //       {
  //         img:
  //           "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcTdx0GyMNP4AfCdH2MnyyWFPtqZGOyXMAyPdt8vNoIS3TEkHhxn",
  //         name: "Jason Derulo",
  //         phone: "88999846"
  //       },
  //       {
  //         img:
  //           "http://www.redblackhair.com/wp-content/uploads/demi-lovato-ombre-hair-color.jpg",
  //         name: "Demi Lovato",
  //         phone: "98895674"
  //       },
  //       {
  //         img:
  //           "https://katyperryceara.com.br/wp-content/uploads/2014/07/katy-5.jpg",
  //         name: "Katy Perry",
  //         phone: "77998747"
  //       },
  //       {
  //         img:
  //           "http://cache29.fansshare.com/images/willsmith/will-smith-fresh-prince-506802794.jpg",
  //         name: "Will Smith",
  //         phone: "88991765"
  //       },
  //       {
  //         img:
  //           "https://4.bp.blogspot.com/-4P0s3awgEO0/VHkKJ4pqPXI/AAAAAAAABC4/U_lukwfVYEM/s1600/ID-%2BEden.jpg",
  //         name: "Cara Delevingne",
  //         phone: "99887865"
  //       },
  //       {
  //         img:
  //           "http://images1.laweekly.com/imager/me-without-you-is-like-uestlove-without-t/u/original/2473272/snoop_dogg_smoking.jpg",
  //         name: "Snoop Dog",
  //         phone: "99887766"
  //       },
  //       {
  //         img:
  //           "https://onethousandinone.files.wordpress.com/2015/04/bruno-1.jpg",
  //         name: "Bruno Mars",
  //         phone: "75908748"
  //       },
  //       {
  //         img:
  //           "http://suprtickets.com/blog/wp-content/uploads/2014/05/rita-ora-selfie.jpg",
  //         name: "Rita Ora",
  //         phone: "95899830"
  //       }
  //     ]);
  ...
  //         if (
  //           dialpad.hasClass("active") &&
  //           layer.hasClass("active") &&
  //           buttonWrapper.hasClass("active")
  //         ) {
  //           setTimeout(function() {
  //             layer.toggleClass("animation");
  //             setTimeout(function() {
